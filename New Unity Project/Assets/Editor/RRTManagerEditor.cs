...
{
    /// <summary>
    /// Editor helper for RRTManager: adds a "Make Scene Screenshot" button to capture the Scene view to a PNG file.
    /// Use by selecting the GameObject that has the RRTManager component.
    /// </summary>
    [CustomEditor(typeof(RRTManager))]
    public sealed class RRTManagerEditor : Editor
    {
